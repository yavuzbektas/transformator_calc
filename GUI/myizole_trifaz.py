from QT_file.mainizole_trifaz import Ui_MainWindow
from PySide2.QtWidgets import QMainWindow,QMessageBox,QTableWidgetItem,QDoubleSpinBox,QComboBox,QLineEdit,\
...
def table_update(data, headers, sender):
    ...
    if data:
        ...
        sender.clear()
# ==========================================================
class IzoleTrifazwindow(QMainWindow):
    def __init__(self, parent=None):
        super(IzoleTrifazwindow, self).__init__(parent)
        self.ui = Ui_MainWindow()
        self.ui.setupUi(self)
        self.setWindowTitle("Trafo Hesaplama Programı V0 - İzolasyon Trafosu Trifaz Hesaplama")
    ...
    def hesaplamalari_guncelle(self):
        ...
        self.hesap_yap(gl=self.group_name_list_sekonder,
                       ...
                       dig_par=self.ui.doubleSpinBox_64.value(),
                       dig_yog=self.ui.doubleSpinBox_65.value(),
                       kademe=int(self.ui.comboBox_sekonder.currentText()))
    # ======================  open popups =========================
    ...
    def open_kesit_hesaplama(self):
        ...
        if baglanti_turu == "p":
            ...
            self.window3.baglanti_turu = self.ui.comboBox_baglanti_primer.currentText()
        elif baglanti_turu == "sek":
            self.window3.kademe = int(sender.objectName().split("_")[len(sender.objectName().split("_")) - 1])
            self.window3.guc = self.ui.doubleSpinBox_guc.value()
            self.window3.gn1 = self.group_name_list_sekonder
            self.window3.gn2 = self.group_name_list_sekonder_2
            ...
            self.window3.baglanti_turu=self.ui.comboBox_baglanti_sekonder.currentText()
        else:
            pass
...
# ======================  IZOLASYONLAR =========================
 ...
 # ================= karkas =====================================
    ...
    def bosluk_hesapla(self):
        ...
        primer_top_yuk = gl[0][42].value() + gl[1][42].value() + gl[2][42].value() + gl[3][42].value() + gl[4][
            42].value() + gl[5][42].value() + gl[6][42].value() + gl[7][42].value() + gl[8][42].value() + gl[9][
                             42].value()
        gl = self.group_name_list_sekonder
        sekonder_top_yuk = gl[0][42].value() + gl[1][42].value() + gl[2][42].value() + gl[3][42].value() + gl[4][
            42].value() + gl[5][42].value() + gl[6][42].value() + gl[7][42].value() + gl[8][42].value() + gl[9][
                               42].value()

        if self.ui.comboBox_sactipi.currentIndex() == 0 :
            bosluk = hp.bosluk_hesap_1(karkas_en=self.ui.doubleSpinBox_karkas_en.value(),
                                    primer_top_yuk=primer_top_yuk, sekonder_top_yuk=sekonder_top_yuk,
    ...
    def agirlik_hesapla(self):
        ...
        gl = self.group_name_list_sekonder
        sekonder_toplam_agirlik = gl[0][41].value() + gl[1][41].value() + gl[2][41].value() + gl[3][41].value() + \
                                  gl[4][41].value() + gl[5][41].value() + gl[6][41].value() + gl[7][41].value() + \
                                  gl[8][41].value() + gl[9][41].value()
        sekonder_cu_agirlik = gl[0][41].value() * gl[0][11].currentIndex() + gl[1][41].value() * gl[1][
            11].currentIndex() + gl[2][41].value() * gl[2][11].currentIndex() + gl[3][41].value() * gl[3][
                                  11].currentIndex() + gl[4][41].value() * gl[4][11].currentIndex() + gl[5][
                                  41].value() * gl[5][11].currentIndex() + gl[6][41].value() * gl[6][
                                  11].currentIndex() + gl[7][41].value() * gl[7][11].currentIndex() + gl[8][
                                  41].value() * gl[8][11].currentIndex() + gl[9][41].value() * gl[9][
                                  11].currentIndex()
        sekonder_al_agirlik = sekonder_toplam_agirlik - sekonder_cu_agirlik
    ...
    def trafoolcu_hesapla(self):
        ...
        self.ui.doubleSpinBox_trafoolcu_d.setValue(
            self.ui.doubleSpinBox_trafoolcu_a.value() - self.ui.doubleSpinBox_karkas_en.value() / 2 - 10)
        self.ui.doubleSpinBox_trafoolcu_e.setValue(
            self.ui.doubleSpinBox_karkas_boy.value() + self.ui.doubleSpinBox_karkas_en.value() / 2 + 2 + 2)
...
# ================= PRIMER ===============================
    ...
    def sekonder_veri_kumesi(self):
        self.group_list_sekonder_1 = [self.ui.doubleSpinBox_akim_sk_1, self.ui.doubleSpinBox_akim_2_sk_1,
                                      ...
                                      self.ui.doubleSpinBox_folyotel_11_sk_1,
                                      self.ui.doubleSpinBox_folyotel_12_sk_1,
                                      self.ui.doubleSpinBox_folyotel_21_sk_1,
                                      self.ui.doubleSpinBox_folyotel_22_sk_1,
                                      self.ui.doubleSpinBox_folyotel_31_sk_1,
                                      self.ui.doubleSpinBox_folyotel_32_sk_1,
                                      self.ui.doubleSpinBox_folyotel_41_sk_1,
                                      self.ui.doubleSpinBox_folyotel_42_sk_1,
                                      ...
                                      self.ui.doubleSpinBox_kare_tel_11_sk_1,
                                      self.ui.doubleSpinBox_kare_tel_12_sk_1,
                                      self.ui.doubleSpinBox_kare_tel_21_sk_1,
                                      self.ui.doubleSpinBox_kare_tel_22_sk_1,
                                      self.ui.doubleSpinBox_kare_tel_31_sk_1,
                                      self.ui.doubleSpinBox_kare_tel_32_sk_1,
                                      self.ui.doubleSpinBox_kare_tel_41_sk_1,
                                      self.ui.doubleSpinBox_kare_tel_42_sk_1,  # 31
        ...
        self.group_list_sekonder_2 = [self.ui.doubleSpinBox_akim_sk_2, self.ui.doubleSpinBox_akim_2_sk_2,
                                      ...
                                      self.ui.doubleSpinBox_folyotel_11_sk_2,
                                      self.ui.doubleSpinBox_folyotel_12_sk_2,
                                      self.ui.doubleSpinBox_folyotel_21_sk_2,
                                      self.ui.doubleSpinBox_folyotel_22_sk_2,
                                      self.ui.doubleSpinBox_folyotel_31_sk_2,
                                      self.ui.doubleSpinBox_folyotel_32_sk_2,
                                      self.ui.doubleSpinBox_folyotel_41_sk_2,
                                      self.ui.doubleSpinBox_folyotel_42_sk_2,
                                      ...
                                      self.ui.doubleSpinBox_kare_tel_11_sk_2,
                                      self.ui.doubleSpinBox_kare_tel_12_sk_2,
                                      self.ui.doubleSpinBox_kare_tel_21_sk_2,
                                      self.ui.doubleSpinBox_kare_tel_22_sk_2,
                                      self.ui.doubleSpinBox_kare_tel_31_sk_2,
                                      self.ui.doubleSpinBox_kare_tel_32_sk_2,
                                      self.ui.doubleSpinBox_kare_tel_41_sk_2,
                                      self.ui.doubleSpinBox_kare_tel_42_sk_2,
        ...
        self.group_list_sekonder_3 = [self.ui.doubleSpinBox_akim_sk_3, self.ui.doubleSpinBox_akim_2_sk_3,
                                      ...
                                      self.ui.doubleSpinBox_folyotel_11_sk_3,
                                      self.ui.doubleSpinBox_folyotel_12_sk_3,
                                      self.ui.doubleSpinBox_folyotel_21_sk_3,
                                      self.ui.doubleSpinBox_folyotel_22_sk_3,
                                      self.ui.doubleSpinBox_folyotel_31_sk_3,
                                      self.ui.doubleSpinBox_folyotel_32_sk_3,
                                      self.ui.doubleSpinBox_folyotel_41_sk_3,
                                      self.ui.doubleSpinBox_folyotel_42_sk_3,
                                      ...
                                      self.ui.doubleSpinBox_kare_tel_11_sk_3,
                                      self.ui.doubleSpinBox_kare_tel_12_sk_3,
                                      self.ui.doubleSpinBox_kare_tel_21_sk_3,
                                      self.ui.doubleSpinBox_kare_tel_22_sk_3,
                                      self.ui.doubleSpinBox_kare_tel_31_sk_3,
                                      self.ui.doubleSpinBox_kare_tel_32_sk_3,
                                      self.ui.doubleSpinBox_kare_tel_41_sk_3,
                                      self.ui.doubleSpinBox_kare_tel_42_sk_3,
        ...
        self.group_list_sekonder_4 = [self.ui.doubleSpinBox_akim_sk_4, self.ui.doubleSpinBox_akim_2_sk_4,
                                      ...
                                      self.ui.doubleSpinBox_folyotel_11_sk_4,
                                      self.ui.doubleSpinBox_folyotel_12_sk_4,
                                      self.ui.doubleSpinBox_folyotel_21_sk_4,
                                      self.ui.doubleSpinBox_folyotel_22_sk_4,
                                      self.ui.doubleSpinBox_folyotel_31_sk_4,
                                      self.ui.doubleSpinBox_folyotel_32_sk_4,
                                      self.ui.doubleSpinBox_folyotel_41_sk_4,
                                      self.ui.doubleSpinBox_folyotel_42_sk_4,
                                      ...
                                      self.ui.doubleSpinBox_kare_tel_11_sk_4,
                                      self.ui.doubleSpinBox_kare_tel_12_sk_4,
                                      self.ui.doubleSpinBox_kare_tel_21_sk_4,
                                      self.ui.doubleSpinBox_kare_tel_22_sk_4,
                                      self.ui.doubleSpinBox_kare_tel_31_sk_4,
                                      self.ui.doubleSpinBox_kare_tel_32_sk_4,
                                      self.ui.doubleSpinBox_kare_tel_41_sk_4,
                                      self.ui.doubleSpinBox_kare_tel_42_sk_4,
        ...
        self.group_list_sekonder_5 = [self.ui.doubleSpinBox_akim_sk_5, self.ui.doubleSpinBox_akim_2_sk_5,
                                      ...
                                      self.ui.doubleSpinBox_folyotel_11_sk_5,
                                      self.ui.doubleSpinBox_folyotel_12_sk_5,
                                      self.ui.doubleSpinBox_folyotel_21_sk_5,
                                      self.ui.doubleSpinBox_folyotel_22_sk_5,
                                      self.ui.doubleSpinBox_folyotel_31_sk_5,
                                      self.ui.doubleSpinBox_folyotel_32_sk_5,
                                      self.ui.doubleSpinBox_folyotel_41_sk_5,
                                      self.ui.doubleSpinBox_folyotel_42_sk_5,
                                      ...
                                      self.ui.doubleSpinBox_kare_tel_11_sk_5,
                                      self.ui.doubleSpinBox_kare_tel_12_sk_5,
                                      self.ui.doubleSpinBox_kare_tel_21_sk_5,
                                      self.ui.doubleSpinBox_kare_tel_22_sk_5,
                                      self.ui.doubleSpinBox_kare_tel_31_sk_5,
                                      self.ui.doubleSpinBox_kare_tel_32_sk_5,
                                      self.ui.doubleSpinBox_kare_tel_41_sk_5,
                                      self.ui.doubleSpinBox_kare_tel_42_sk_5,
        ...
        self.group_list_sekonder_6 = [self.ui.doubleSpinBox_akim_sk_6, self.ui.doubleSpinBox_akim_2_sk_6,
                                      ...
                                      self.ui.doubleSpinBox_folyotel_11_sk_6,
                                      self.ui.doubleSpinBox_folyotel_12_sk_6,
                                      self.ui.doubleSpinBox_folyotel_21_sk_6,
                                      self.ui.doubleSpinBox_folyotel_22_sk_6,
                                      self.ui.doubleSpinBox_folyotel_31_sk_6,
                                      self.ui.doubleSpinBox_folyotel_32_sk_6,
                                      self.ui.doubleSpinBox_folyotel_41_sk_6,
                                      self.ui.doubleSpinBox_folyotel_42_sk_6,
                                      ...
                                      self.ui.doubleSpinBox_kare_tel_11_sk_6,
                                      self.ui.doubleSpinBox_kare_tel_12_sk_6,
                                      self.ui.doubleSpinBox_kare_tel_21_sk_6,
                                      self.ui.doubleSpinBox_kare_tel_22_sk_6,
                                      self.ui.doubleSpinBox_kare_tel_31_sk_6,
                                      self.ui.doubleSpinBox_kare_tel_32_sk_6,
                                      self.ui.doubleSpinBox_kare_tel_41_sk_6,
                                      self.ui.doubleSpinBox_kare_tel_42_sk_6,
        ...
        self.group_list_sekonder_7 = [self.ui.doubleSpinBox_akim_sk_7, self.ui.doubleSpinBox_akim_2_sk_7,
                                      ...
                                      self.ui.doubleSpinBox_folyotel_11_sk_7,
                                      self.ui.doubleSpinBox_folyotel_12_sk_7,
                                      self.ui.doubleSpinBox_folyotel_21_sk_7,
                                      self.ui.doubleSpinBox_folyotel_22_sk_7,
                                      self.ui.doubleSpinBox_folyotel_31_sk_7,
                                      self.ui.doubleSpinBox_folyotel_32_sk_7,
                                      self.ui.doubleSpinBox_folyotel_41_sk_7,
                                      self.ui.doubleSpinBox_folyotel_42_sk_7,
                                      ...
                                      self.ui.doubleSpinBox_kare_tel_11_sk_7,
                                      self.ui.doubleSpinBox_kare_tel_12_sk_7,
                                      self.ui.doubleSpinBox_kare_tel_21_sk_7,
                                      self.ui.doubleSpinBox_kare_tel_22_sk_7,
                                      self.ui.doubleSpinBox_kare_tel_31_sk_7,
                                      self.ui.doubleSpinBox_kare_tel_32_sk_7,
                                      self.ui.doubleSpinBox_kare_tel_41_sk_7,
                                      self.ui.doubleSpinBox_kare_tel_42_sk_7,
        ...
        self.group_list_sekonder_8 = [self.ui.doubleSpinBox_akim_sk_8, self.ui.doubleSpinBox_akim_2_sk_8,
                                      ...
                                      self.ui.doubleSpinBox_folyotel_11_sk_8,
                                      self.ui.doubleSpinBox_folyotel_12_sk_8,
                                      self.ui.doubleSpinBox_folyotel_21_sk_8,
                                      self.ui.doubleSpinBox_folyotel_22_sk_8,
                                      self.ui.doubleSpinBox_folyotel_31_sk_8,
                                      self.ui.doubleSpinBox_folyotel_32_sk_8,
                                      self.ui.doubleSpinBox_folyotel_41_sk_8,
                                      self.ui.doubleSpinBox_folyotel_42_sk_8,
                                      ...
                                      self.ui.doubleSpinBox_kare_tel_11_sk_8,
                                      self.ui.doubleSpinBox_kare_tel_12_sk_8,
                                      self.ui.doubleSpinBox_kare_tel_21_sk_8,
                                      self.ui.doubleSpinBox_kare_tel_22_sk_8,
                                      self.ui.doubleSpinBox_kare_tel_31_sk_8,
                                      self.ui.doubleSpinBox_kare_tel_32_sk_8,
                                      self.ui.doubleSpinBox_kare_tel_41_sk_8,
                                      self.ui.doubleSpinBox_kare_tel_42_sk_8,
        ...
        self.group_list_sekonder_9 = [self.ui.doubleSpinBox_akim_sk_9, self.ui.doubleSpinBox_akim_2_sk_9,
                                      ...
                                      self.ui.doubleSpinBox_folyotel_11_sk_9,
                                      self.ui.doubleSpinBox_folyotel_12_sk_9,
                                      self.ui.doubleSpinBox_folyotel_21_sk_9,
                                      self.ui.doubleSpinBox_folyotel_22_sk_9,
                                      self.ui.doubleSpinBox_folyotel_31_sk_9,
                                      self.ui.doubleSpinBox_folyotel_32_sk_9,
                                      self.ui.doubleSpinBox_folyotel_41_sk_9,
                                      self.ui.doubleSpinBox_folyotel_42_sk_9,
                                      ...
                                      self.ui.doubleSpinBox_kare_tel_11_sk_9,
                                      self.ui.doubleSpinBox_kare_tel_12_sk_9,
                                      self.ui.doubleSpinBox_kare_tel_21_sk_9,
                                      self.ui.doubleSpinBox_kare_tel_22_sk_9,
                                      self.ui.doubleSpinBox_kare_tel_31_sk_9,
                                      self.ui.doubleSpinBox_kare_tel_32_sk_9,
                                      self.ui.doubleSpinBox_kare_tel_41_sk_9,
                                      self.ui.doubleSpinBox_kare_tel_42_sk_9,
        ...
        self.group_list_sekonder_10 = [self.ui.doubleSpinBox_akim_sk_10, self.ui.doubleSpinBox_akim_2_sk_10,
                                       ...
                                       self.ui.doubleSpinBox_folyotel_11_sk_10,
                                       self.ui.doubleSpinBox_folyotel_12_sk_10,
                                       self.ui.doubleSpinBox_folyotel_21_sk_10,
                                       self.ui.doubleSpinBox_folyotel_22_sk_10,
                                       self.ui.doubleSpinBox_folyotel_31_sk_10,
                                       self.ui.doubleSpinBox_folyotel_32_sk_10,
                                       self.ui.doubleSpinBox_folyotel_41_sk_10,
                                       self.ui.doubleSpinBox_folyotel_42_sk_10,
                                       ...
                                       self.ui.doubleSpinBox_kare_tel_11_sk_10,
                                       self.ui.doubleSpinBox_kare_tel_12_sk_10,
                                       self.ui.doubleSpinBox_kare_tel_21_sk_10,
                                       self.ui.doubleSpinBox_kare_tel_22_sk_10,
                                       self.ui.doubleSpinBox_kare_tel_31_sk_10,
                                       self.ui.doubleSpinBox_kare_tel_32_sk_10,
                                       self.ui.doubleSpinBox_kare_tel_41_sk_10,
                                       self.ui.doubleSpinBox_kare_tel_42_sk_10,
        ...
        self.group_name_list_sekonder_2 = [self.group_list_sekonder_11, self.group_list_sekonder_22,
                                           self.group_list_sekonder_32,
                                           self.group_list_sekonder_42, self.group_list_sekonder_52,
                                           self.group_list_sekonder_62,
                                           self.group_list_sekonder_72, self.group_list_sekonder_82,
                                           self.group_list_sekonder_92,
        ...
        self.kademe_grouplist_sekonder = [self.ui.groupBox_sek1, self.ui.groupBox_sek2, self.ui.groupBox_sek3,
                                          self.ui.groupBox_sek4,
                                          self.ui.groupBox_sek5, self.ui.groupBox_sek6, self.ui.groupBox_sek7,
                                          self.ui.groupBox_sek8,
                                          self.ui.groupBox_sek9, self.ui.groupBox_sek10]
    def sekonder_object_signals(self):
        self.ui.comboBox_sekonder.currentTextChanged.connect(self.sekonder_kademe_goster)
        ...
        for i in range(0, 10):
            ...
            # self.group_name_list_1[i][47].clicked.connect(self.va_open_tel_secim_gnl)
            # self.group_name_list_1[i][48].clicked.connect(self.va_open_tel_secim_gnl)
            self.group_name_list_sekonder[i][32].currentTextChanged.connect(self.sekonder_kademe_goster)
            self.group_name_list_sekonder[i][10].currentTextChanged.connect(self.sekonder_kademe_goster)
            self.group_name_list_sekonder[i][8].currentTextChanged.connect(self.sekonder_kademe_goster)
            self.group_name_list_sekonder[i][9].currentTextChanged.connect(self.sekonder_kademe_goster)
            self.group_name_list_sekonder[i][7].valueChanged.connect(self.hesaplamalari_guncelle)
            self.group_name_list_sekonder[i][49].stateChanged.connect(self.hesaplamalari_guncelle)
            self.group_name_list_sekonder[i][41].valueChanged.connect(self.hesaplamalari_guncelle)
            self.group_name_list_sekonder[i][6].valueChanged.connect(self.hesaplamalari_guncelle)
            for y in range(11, 33):
                self.object_multi_connect(object=self.group_name_list_sekonder[i][y], arg=(self.hesaplamalari_guncelle))
            for y in range(54, 58):
                self.object_multi_connect(object=self.group_name_list_sekonder[i][y], arg=(self.hesaplamalari_guncelle))
    def sekonder_tel_kademe_resetle(self):
        for index in range(0,10):
            self.kademe_goster(object=self.group_name_list_sekonder[index][10], group_list=self.kademe_list_sekonder[index])
            self.kademe_goster(object=self.group_name_list_sekonder[index][8], group_list=self.kademe_list_sekonder[index+10])
            self.kademe_goster(object=self.group_name_list_sekonder[index][9], group_list=self.kademe_list_sekonder[index+20])
    ...
    def sekonder_kademe_goster(self):
        self.kademe_goster(object=self.ui.comboBox_sekonder, group_list=self.kademe_grouplist_sekonder)

        self.hesaplamalari_guncelle()
        self.sekonder_tel_kademe_resetle()
# ========================================================
    def hesap_yap(self,gl,gl2,guc,frekans,gauss,karkas_en,karkas_boy,verim,karkas_yuk,baglanti,sarim,cu_par, cu_yog, al_par, al_yog, dig_par, dig_yog,kademe=1):
        ...
        for i in range(0,10):
            if gl[i][7].value() > 0 and kademe > i:
                ...
                if baglanti=="Yıldız":
                    # spir 1 Hesabı -------------------------
                    gl[i][4].setValue(hp.spir_hesap_3(
                    ...
                    if gl[i][49].isChecked():
                        ...
                        gl[i][6].setValue(hp.spir_hesap_5(
                            gerilim=gl[i][7].value(),
                            frekans=frekans,
                            gauss=gauss,
                            karkas_en=karkas_en,
                    ...
                    # spir 1 Hesabı -------------------------
                    gl[i][4].setValue(hp.spir_hesap_4(
                        gerilim=gl[i][7].value(),
                        frekans=frekans,
                        gauss=gauss,
                        karkas_en=karkas_en,
                    ...
                    if gl[i][49].isChecked():
                        ...
                        gl[i][6].setValue(hp.spir_hesap_6(
                            ...
                            verim=verim))
                    # Akım 1 Hesabı -------------------------
                    gl[i][0].setValue( hp.akim_hesap_4(guc=guc,gerilim=gl[i][7].value()))
    ...
    def hesap_sarim_uzunlugu(self):
        ...
        self.sekonder_sarim_yukseklik_toplam =0
        for i in range(0,10):
            self.primer_sarim_yukseklik_toplam =self.primer_sarim_yukseklik_toplam + self.group_name_list_1[i][42].value()
            self.sekonder_sarim_yukseklik_toplam =self.sekonder_sarim_yukseklik_toplam + self.group_name_list_sekonder[i][42].value()
    ...
    def tum_degerleri_temizle(self):
        ...
        while tekrar !=3:
            ...
            self.ui.comboBox_sekonder.setCurrentIndex(0)
            ...
            self.ui.doubleSpinBox_sekonderagirlik_al.setValue(0)
            self.ui.doubleSpinBox_sekonderagirlik_cu.setValue(0)
            primer_al_agirlik=0
            primer_toplam_agirlik=0
            primer_cu_agirlik=0
            sekonder_al_agirlik = 0
            sekonder_toplam_agirlik =0
            ...
            self.ui.doubleSpinBox_v_sk_1.setValue(0)
            self.ui.doubleSpinBox_v_sk_2.setValue(0)
            self.ui.doubleSpinBox_v_sk_3.setValue(0)
            self.ui.doubleSpinBox_v_sk_4.setValue(0)
            self.ui.doubleSpinBox_v_sk_5.setValue(0)
            self.ui.doubleSpinBox_v_sk_6.setValue(0)
            self.ui.doubleSpinBox_v_sk_7.setValue(0)
            self.ui.doubleSpinBox_v_sk_8.setValue(0)
            self.ui.doubleSpinBox_v_sk_9.setValue(0)
            self.ui.doubleSpinBox_v_sk_10.setValue(0)
            for y in range(0, 10):
                for i in range(0,57):
                    self.degerleri_temizle(object=self.group_name_list_sekonder[y][i])
...
# ===========================================================
    def printout_veri_kumesi(self):
        ...
        printout.sekonder_group_list = [
            [self.ui.doubleSpinBox_v_sk_1.value(), self.ui.doubleSpinBox_sipir_2_sk_1.value(),
             self.ui.doubleSpinBox_kesit_2_sk_1.value(), self.ui.doubleSpinBox_cap_2_sk_1.value(),
             self.ui.doubleSpinBox_akim_2_sk_1.value(), self.ui.comboBox_tel_sk_1.currentText(),
             self.ui.doubleSpinBox_tel_agirlik_sk_1.value(), self.ui.doubleSpinBox_spirkat_sk_1.value()],
            [self.ui.doubleSpinBox_v_sk_2.value(), self.ui.doubleSpinBox_sipir_2_sk_2.value(),
             self.ui.doubleSpinBox_kesit_2_sk_2.value(), self.ui.doubleSpinBox_cap_2_sk_2.value(),
             self.ui.doubleSpinBox_akim_2_sk_2.value(), self.ui.comboBox_tel_sk_2.currentText(),
             self.ui.doubleSpinBox_tel_agirlik_sk_2.value(), self.ui.doubleSpinBox_spirkat_sk_2.value()],
            [self.ui.doubleSpinBox_v_sk_3.value(), self.ui.doubleSpinBox_sipir_2_sk_3.value(),
             self.ui.doubleSpinBox_kesit_2_sk_3.value(), self.ui.doubleSpinBox_cap_2_sk_3.value(),
             self.ui.doubleSpinBox_akim_2_sk_3.value(), self.ui.comboBox_tel_sk_3.currentText(),
             self.ui.doubleSpinBox_tel_agirlik_sk_3.value(), self.ui.doubleSpinBox_spirkat_sk_3.value()],
            [self.ui.doubleSpinBox_v_sk_4.value(), self.ui.doubleSpinBox_sipir_2_sk_4.value(),
             self.ui.doubleSpinBox_kesit_2_sk_4.value(), self.ui.doubleSpinBox_cap_2_sk_4.value(),
             self.ui.doubleSpinBox_akim_2_sk_4.value(), self.ui.comboBox_tel_sk_4.currentText(),
             self.ui.doubleSpinBox_tel_agirlik_sk_4.value(), self.ui.doubleSpinBox_spirkat_sk_4.value()],
            [self.ui.doubleSpinBox_v_sk_5.value(), self.ui.doubleSpinBox_sipir_2_sk_5.value(),
             self.ui.doubleSpinBox_kesit_2_sk_5.value(), self.ui.doubleSpinBox_cap_2_sk_5.value(),
             self.ui.doubleSpinBox_akim_2_sk_5.value(), self.ui.comboBox_tel_sk_5.currentText(),
             self.ui.doubleSpinBox_tel_agirlik_sk_5.value(), self.ui.doubleSpinBox_spirkat_sk_5.value()],
            [self.ui.doubleSpinBox_v_sk_6.value(), self.ui.doubleSpinBox_sipir_2_sk_6.value(),
             self.ui.doubleSpinBox_kesit_2_sk_6.value(), self.ui.doubleSpinBox_cap_2_sk_6.value(),
             self.ui.doubleSpinBox_akim_2_sk_6.value(), self.ui.comboBox_tel_sk_6.currentText(),
             self.ui.doubleSpinBox_tel_agirlik_sk_6.value(), self.ui.doubleSpinBox_spirkat_sk_6.value()],
            [self.ui.doubleSpinBox_v_sk_7.value(), self.ui.doubleSpinBox_sipir_2_sk_7.value(),
             self.ui.doubleSpinBox_kesit_2_sk_7.value(), self.ui.doubleSpinBox_cap_2_sk_7.value(),
             self.ui.doubleSpinBox_akim_2_sk_7.value(), self.ui.comboBox_tel_sk_7.currentText(),
             self.ui.doubleSpinBox_tel_agirlik_sk_7.value(), self.ui.doubleSpinBox_spirkat_sk_7.value()],
            [self.ui.doubleSpinBox_v_sk_8.value(), self.ui.doubleSpinBox_sipir_2_sk_8.value(),
             self.ui.doubleSpinBox_kesit_2_sk_8.value(), self.ui.doubleSpinBox_cap_2_sk_8.value(),
             self.ui.doubleSpinBox_akim_2_sk_8.value(), self.ui.comboBox_tel_sk_8.currentText(),
             self.ui.doubleSpinBox_tel_agirlik_sk_8.value(), self.ui.doubleSpinBox_spirkat_sk_8.value()],
            [self.ui.doubleSpinBox_v_sk_9.value(), self.ui.doubleSpinBox_sipir_2_sk_9.value(),
             self.ui.doubleSpinBox_kesit_2_sk_9.value(), self.ui.doubleSpinBox_cap_2_sk_9.value(),
             self.ui.doubleSpinBox_akim_2_sk_9.value(), self.ui.comboBox_tel_sk_9.currentText(),
             self.ui.doubleSpinBox_tel_agirlik_sk_9.value(), self.ui.doubleSpinBox_spirkat_sk_9.value()],
            [self.ui.doubleSpinBox_v_sk_10.value(), self.ui.doubleSpinBox_sipir_2_sk_10.value(),
             self.ui.doubleSpinBox_kesit_2_sk_10.value(), self.ui.doubleSpinBox_cap_2_sk_10.value(),
             self.ui.doubleSpinBox_akim_2_sk_10.value(), self.ui.comboBox_tel_sk_10.currentText(),
             self.ui.doubleSpinBox_tel_agirlik_sk_10.value(), self.ui.doubleSpinBox_spirkat_sk_10.value()]]
    def printout_report(self):
        ...
        printout.sekonder_kademe = int(self.ui.comboBox_sekonder.currentText())
        ...
        printout.toplam_ag = str(self.ui.doubleSpinBox_primeragirlik_al.value() + self.ui.doubleSpinBox_sekonderagirlik_al.value() +\
            self.ui.doubleSpinBox_primeragirlik_cu.value() +self.ui.doubleSpinBox_sekonderagirlik_cu.value()) + "kg"
        ...
        printout.trafo_olcu = str(self.ui.doubleSpinBox_trafoolcu_a.value()) + " x " + str( \
            self.ui.doubleSpinBox_trafoolcu_b.value()) + " x " + str(self.ui.doubleSpinBox_trafoolcu_c.value()) \
                              + " x " + str(self.ui.doubleSpinBox_trafoolcu_d.value()) + " x " + str(
            self.ui.doubleSpinBox_trafoolcu_e.value())
