...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(526, 129)
        self.pushButton_sec = QPushButton(Dialog)
        self.pushButton_sec.setObjectName(u"pushButton_sec")
        self.pushButton_sec.setGeometry(QRect(440, 80, 80, 41))
        self.groupBox_3 = QGroupBox(Dialog)
        self.groupBox_3.setObjectName(u"groupBox_3")
        self.groupBox_3.setGeometry(QRect(10, 0, 421, 121))
        font = QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.doubleSpinBox_sac.setSingleStep(0.100000000000000)
