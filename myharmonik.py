...
class Harmonikwindow(QMainWindow):
    def __init__(self,parent=None):
        ...
        self.veri_kumeleri()
        self.setWindowTitle("Harmonik Trafosu - Trafo Hesaplama")
        self.handle_button()
        self.index=0
    ...
    def handle_button(self):
        ...
        self.ui.doubleSpinBox_nuvebosluk.valueChanged.connect(self.hesaplamalari_guncelle)
    ...
    def open_recete(self):
        ...
        self.window3.setWindowTitle("Recete Sayfası - Harmonik  Trafoları ")
    ...
    def open_kesit_hesaplama(self):
        ...
        index=0
        self.window3.trafoTipi="trifaz_Harmonik"
        ...
        self.window3.sacTipi = self.ui.comboBox_sactipi.currentIndex()
        self.window3.nuveBosluk=self.ui.doubleSpinBox_nuvebosluk.value()
        self.window3.sacYogunluk=self.ui.doubleSpinBox_sacYogunluk.value()
        self.window3.show()
    ...
    def recete_veri_kumesi(self,veri_kumesi):
        ...
        veri_kumesi.rec_veriler["trafo_tipi" ]= "Harmonik Trafosu"
    ...
    def hesap_1_gnl(self,gl,gl2,guc,frekans,gauss,karkas_en,karkas_boy,karkas_yuk,verim,sarim,baglanti,kademe=1):
        ...
        degerler=hp.trafo_hesap_trifaz_Harmonik(gl, guc, frekans,
                        ...
                        sacTipi=self.ui.comboBox_sactipi.currentIndex(),
                        nuveBosluk=self.ui.doubleSpinBox_nuvebosluk.value(),
                        sacYogunluk=self.ui.doubleSpinBox_sacYogunluk.value())
        ...
        if len(degerler)>1:
            ...
            self.ui.doubleSpinBox_kesmeSacAgirlik.setValue( degerler["kesmeSac_agirlik"])
    ...
    def printout_veri_kumesi(self):
        ...
        printout.trafo_tipi = " Harmonik Trafosu  Hesap Ozeti"
    ...
    def printout_report(self):
        ...
        printout.trifazHarmonik_printout()
