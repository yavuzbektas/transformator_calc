...
class MonoUIwindow(QMainWindow):
    def __init__(self,parent=None):
        ...
        self.veri_kumeleri()
        self.setWindowTitle("Monofaz UI Izolasyon Trafosu - Trafo Hesaplama")
        self.handle_button()
        self.index=0
    ...
    def open_recete(self):
        ...
        self.window3.setWindowTitle("Recete Sayfası - Monofaz UI Izolasyon Trafoları ")
    ...
    def open_kesit_hesaplama(self):
        ...
        index=0
        self.window3.trafoTipi="monofazUI_izole"
    ...
    def recete_veri_kumesi(self,veri_kumesi):
        ...
        veri_kumesi.rec_veriler["trafo_tipi" ]= " Monofaz UI Izolasyon Trafosu  "
    ...
    def bosluk_hesapla(self):
        ...
        if self.ui.comboBox_sactipi.currentIndex()==0 :
            ...
            bosluk=hp.bosluk_hesap_2(
                ...
                sva1_yuk= 0,sva2_yuk= 0,sva3_yuk= 0,sva4_yuk= 0,sva5_yuk= 0,
                sva6_yuk= 0,sva7_yuk= 0,sva8_yuk= 0,sva9_yuk= 0,sva10_yuk= 0,toplam_izolasyon=self.toplam_izolasyon)
    ...
    def printout_veri_kumesi(self):
        ...
        printout.trafo_tipi = " MonoFaz UI Izolasyon Trafosu  Hesap Ozeti"
    ...
    def printout_report(self):
        ...
        printout.izolasyon_monofazUI_printout()
