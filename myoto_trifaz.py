...
class OtoTrifazwindow(QMainWindow):
    def __init__(self,parent=None):
        ...
        self.veri_kumeleri()
        self.setWindowTitle("Oto Trifaz Trafosu - Trafo Hesaplama")
        self.handle_button()
        self.index=0
    ...
    def recete_veri_kumesi(self,veri_kumesi):
        ...
        veri_kumesi.rec_veriler["trafo_tipi" ]= " Oto Trafosu Trifaz "
    ...
    def karkas_hesaplama(self):
        ...
        self.ui.doubleSpinBox_guc_izolasyon_karsiligi.setValue(hp.karkas_izole_Ac_oto(akim=gl[0]["akim1"],
                                                                   gerilim=gl[0]["voltaj"]))
    ...
    def trafoolcu_hesapla(self):
        if self.ui.comboBox_sactipi.currentIndex()==1:
            ...
            self.ui.doubleSpinBox_sacagirlik.setValue(hp.sac_agirlik_trifaz(
                karkas_en=self.ui.doubleSpinBox_karkas_en.value(),
                karkas_boy=self.ui.doubleSpinBox_karkas_boy.value()))
    ...
    def printout_report(self):
        ...
        printout.ototrafo_trifaz_printout(self.ui.doubleSpinBox_guc_izolasyon_karsiligi.value())
