...
class SokMonofazwindow(QMainWindow):
    def __init__(self,parent=None):
        ...
        self.veri_kumeleri()
        self.setWindowTitle("Şok Mono Faz Trafosu - Trafo Hesaplama")
        self.handle_button()
        self.index=0
    ...
    def open_recete(self):
        ...
        self.window3.setWindowTitle("Recete Sayfası - Şok Monofaz  Trafoları ")
    ...
    def open_kesit_hesaplama(self):
        ...
        index=0
        self.window3.trafoTipi="monofaz_sok"
    ...
    def recete_veri_kumesi(self,veri_kumesi):
        ...
        veri_kumesi.rec_veriler["trafo_tipi" ]= " Şok Trafosu Monofaz "
    ...
    def hesap_1_gnl(self,gl,gl2,guc,frekans,gauss,karkas_en,karkas_boy,karkas_yuk,verim,sarim,baglanti,kademe=1):
        ...
        if len(degerler)>1:
            #Gself.ui.doubleSpinBox_apSacaGore.setValue(degerler["ApSac"])
    ...
    def printout_veri_kumesi(self):
        ...
        printout.trafo_tipi = " Şok Mono Faz Trafosu  Hesap Ozeti"
