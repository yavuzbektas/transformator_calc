...
class SontTrifazwindow(QMainWindow):
    def __init__(self,parent=None):
        ...
        self.veri_kumeleri()
        self.setWindowTitle("Şönt Trifaz Trafo - Trafo Hesaplama")
        self.handle_button()
        self.index=0
    ...
    def open_recete(self):
        ...
        self.window3.setWindowTitle("Recete Sayfası - Şönt Trifaz  Trafoları ")
    ...
    def open_kesit_hesaplama(self):
        ...
        index=0
        self.window3.trafoTipi="trifaz_sont"
    ...
    def recete_veri_kumesi(self,veri_kumesi):
        ...
        veri_kumesi.rec_veriler["trafo_tipi" ]= " Şönt Trafosu Trifaz "
    ...
    def agirlik_hesapla(self):
        ...
        self.ui.doubleSpinBox_toplamagirlik_al.setValue(primer_al_agirlik*3)
        self.ui.doubleSpinBox_toplamagirlik_cu.setValue(primer_cu_agirlik*3)
        self.ui.doubleSpinBox_primeragirlik_al.setValue(primer_al_agirlik*3)
        self.ui.doubleSpinBox_primeragirlik_cu.setValue(primer_cu_agirlik*3)
    ...
    def hesap_1_gnl(self,gl,gl2,guc,frekans,gauss,karkas_en,karkas_boy,karkas_yuk,verim,sarim,baglanti,kademe=1):
        ...
        if len(degerler)>0:
            ...
            self.ui.doubleSpinBox_trafoolcu_a.setValue(degerler["trafoOlcu_a"])
            self.ui.doubleSpinBox_trafoolcu_b.setValue(degerler["trafoOlcu_b"])
            self.ui.doubleSpinBox_trafoolcu_c.setValue(degerler["trafoOlcu_c"])
            self.ui.doubleSpinBox_trafoolcu_d.setValue(degerler["trafoOlcu_d"])
            self.ui.doubleSpinBox_trafoolcu_e.setValue(degerler["trafoOlcu_e"])
            self.ui.doubleSpinBox_trafoolcu_f.setValue(degerler["trafoOlcu_f"])
    ...
    def printout_veri_kumesi(self):
        ...
        printout.trafo_tipi = " Şönt Trifaz Trafosu  Hesap Ozeti"
