...
class UPSwindow(QMainWindow):
    def __init__(self,parent=None):
        ...
        self.veri_kumeleri()
        self.setWindowTitle("UPS Trafosu - Trafo Hesaplama")
        self.handle_button()
        self.index=0
    ...
    def open_recete(self):
        ...
        self.window3.setWindowTitle("Recete Sayfası -UPS  Trafoları ")
    ...
    def recete_veri_kumesi(self,veri_kumesi):
        ...
        veri_kumesi.rec_veriler["trafo_tipi" ]= " UPS Trafosu "
    ...
    def printout_veri_kumesi(self):
        ...
        printout.trafo_tipi = " UPS Trafosu Hesap Ozeti"
